...
#define	_FS_TINY		0	/* 0:Normal or 1:Tiny */     //设置缓冲区的位置，为0，每个文件自带一个buf
...
#define	_USE_FASTSEEK	0	/* 0:Disable or 1:Enable */  //设置是否支持文件快速定位，它主要采用缓冲区来存储簇链映射图，以空间换时间
...
#define	_LFN_UNICODE	0	/* 0:ANSI/OEM or 1:Unicode */   //设置长文件名是否支持Unicode
...
#define _FS_RPATH		0	/* 0 to 2 */   //设置相对路径支持。相对路径在编程的时候特别方便，但是为了先移植成功，暂不支持
...
#define _VOLUMES	1     //设置逻辑驱动器的个数，默认为1
...
#define _FS_REENTRANT	0		/* 0:Disable or 1:Enable */    //设置是否重入
#define _FS_TIMEOUT		1000	/* Timeout period in unit of time tick */   //超时设置
#define	_SYNC_t			HANDLE	    //访问重入时的同步句柄
...
#define _WORD_ACCESS	0	/* 0 or 1 */   //设置是否支持字访问
