...
#define	BYTES_WIDTH_PER_FONT_GB_16X16 16

#define BYTES_HEIGHT_PER_FONT_ASCII_16X8 16
#define BYTES_WIDTH_PER_FONT_ASCII_16X8 8

#define BYTES_HEIGHT_PER_FONT_GB_32X32 32
#define	BYTES_WIDTH_PER_FONT_GB_32X32 32

#define BYTES_HEIGHT_PER_FONT_UCS_32X32 32
#define	BYTES_WIDTH_PER_FONT_UCS_32X32 32

#define BYTES_HEIGHT_PER_FONT_ASCII_32X16 32
#define BYTES_WIDTH_PER_FONT_ASCII_32X16 16

#define BYTES_HEIGHT_PER_FONT_GB_24X24 24
#define	BYTES_WIDTH_PER_FONT_GB_24X24 24

#define BYTES_HEIGHT_PER_FONT_ASCII_24X16 24
#define BYTES_WIDTH_PER_FONT_ASCII_24X16 24
